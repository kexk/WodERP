    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-6 col-lg-6">
          <h4>
            <img src="{{ static_url('woderp/img/logo.png') }}">
          </h4>
          <p>以大数据选品、供应链SAAS协同等核心技术支持分销交易和海外销售，以全开放的平台设计实现供应商与分销商的要素资源最优配置</p>
        </div>
      ...
      <div class="row footer-bottom">
        <ul class="list-inline text-center">
          <li><a href="http://www.miibeian.gov.cn/" target="_blank">京ICP备11008151号</a></li><li><a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31011302003488">沪公网安备 31011302003488号</a></li>
        </ul>
      </div>
    </div>
  </footer>
